              ...
              svg.select("g")
                ...
                .attr("height", "3");
                 ...
                 svg
                   ...
                   // .style("x", (X-420)+"px")
                   // .style("y", (Y+50)+"px")
                   .style("x", (projection2(d.geometry.coordinates)[0]-320)+"px")
                   .style("y", (projection2(d.geometry.coordinates)[1]-110)+"px")
                 ...
                 var wenzi =  svg.select("#info")
                   ...
                   // .text(information)
                    .attr('fill','white')
                    .attr('x', (projection2(d.geometry.coordinates)[0]-320)+"px")
                    .attr('y', function(d,i){return i*25+(Y)+"px"})
                    .attr("opacity",1)
